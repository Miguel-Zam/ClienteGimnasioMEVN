                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="profile-img">
                            <img src="https://images.pexels.com/photos/1954524/pexels-photo-1954524.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt=""/>
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                                    <h5>
                                        {{notas[1].Nombre.toUpperCase()}}<br><br><br>
                                    </h5>
                                    <h6>
                                        {{notas[1].Membresia.toUpperCase()}}<br><br><br>
                                    </h6>
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p>{{((parseFloat(notas[1].Peso))/(parseFloat(notas[1].Altura)*parseFloat(notas[1].Altura))).toFixed(2)}}</p>
                                            </div>
                                        </div>
                            </div>

                            <b-button class="btn-warning my-4" @click='activarEdicion(notas[1]._id)'>Editar</b-button>
